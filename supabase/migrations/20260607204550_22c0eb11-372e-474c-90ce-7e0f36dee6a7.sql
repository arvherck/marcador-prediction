DROP FUNCTION IF EXISTS public.score_matchday(int);
...
REVOKE EXECUTE ON FUNCTION public.score_matchday(integer, uuid) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.score_matchday(integer, uuid) TO authenticated, service_role;